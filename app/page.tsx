    ...
    <main>
      <div className="min-h-[85vh]">
        <div className="mb-8">
          ...
          ></h1>
          <div className="flex gap-x-2 mt-2 text-neutral-300">
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-x-6 lg:divide-x divide-none">
          <div className="grid gap-y-1 lg:col-span-2 col-span-1 lg:order-1 order-2">
            {pagePosts.map((post) => (
              <Link
                href={`/blog/${post._id}`}
                key={post._id}
                className="duration-200 flex items-center gap-x-2 hover:bg-[#2E2E2E] hover:pl-2 rounded-lg"
              >
            ...
            <div className="flex font-medium items-center font-mono mt-4">
              <div
          ...
          <div className="mb-3 p-4 lg:order-2 order-1 bg-[#212121] rounded-xl">
              ...
              (value, index) =>
                currentCategory && (
                  <div
                    ...
                    } text-[#999999] text-sm inline-flex mr-1 mb-1 py-1 px-3 rounded-2xl bg-[#2E2E2E] hover:bg-white duration-300`}
                    onClick={() => {
                      currentCategory.includes(value)
                        ? setCurrentCategory(
                            currentCategory.filter((select) => select != value),
                          )
